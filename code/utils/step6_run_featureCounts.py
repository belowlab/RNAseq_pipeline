...
# Note: This code can take multiple .bam files, but in the pipeline I only run one sample at a time and combine all results later
'''
Usage:
...
Example call:
python /data100t1/home/wanying/CCHC/RNAseq_pipeline/code/utils/step6_run_featureCounts.py \
--input_files /data100t1/home/wanying/CCHC/RNAseq_gtex_pipeline/202507_batch5_9560-JB_glp1_and_brazilian/star/9560-JB.A0000641820.Aligned.sortedByCoord.out.bam \
--prefix 9560-JB.A0000641820 \
--output_dir /data100t1/home/wanying/CCHC/RNAseq_gtex_pipeline/202507_batch5_9560-JB_glp1_and_brazilian/featureCounts \
...
parser.add_argument('--input_files', type=str, help='BAM or SAM files, ', nargs='+')
